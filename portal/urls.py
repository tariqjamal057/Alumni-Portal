...
urlpatterns = [
    ...
    path(
        ...
        views.finance_request_detail_page,
        name="request_detail_page",
    ),
    path(
        "alumni_as_sponser_chat/<int:pk>",
        views.alumni_as_sponser_chat,
    ...
    path(
        ...
        views.update_help_desk_post,
        name="update_help_desk_post",
    ),
    path(
        "help_desk_post_detail/<int:pk>", views.help_desk_post_detail, name="help_desk_post_detail"
    ),
    ...
    path(
        ...
        views.get_help_desk_chat_header,
        name="get_help_desk_chat_header",
    ),
    path(
        "help_desk_interest_message/",
        views.help_desk_interest_message,
    ...
    path(
        "help_desk_detail_page/<int:pk>", views.help_desk_detail_page, name="help_desk_detail_page"
    ),
    path("help_desk_chat/<int:pk>", views.help_desk_chat, name="help_desk_chat"),
    path(
        "help_desk_users_message/", views.help_desk_users_message, name="help_desk_users_message"
    ),
    path("student_post_search/", views.student_post_search, name="student_post_search"),
    path(
        "create_mentor_help_post/", views.create_mentor_help_post, name="create_mentor_help_post"
    ),
    path(
        "update_mentor_help_post/<int:pk>/",
        views.update_mentor_help_post,
        name="update_mentor_help_post",
    ),
    path(
        "mentor_help_post_detail/<int:pk>",
        views.mentor_help_post_detail,
        name="mentor_help_post_detail",
    ),
    path(
        "delete_mentor_help_post/", views.delete_mentor_help_post, name="delete_mentor_help_post"
    ),
    path(
        "mentor_help_post_chat/<int:pk>", views.mentor_help_post_chat, name="mentor_help_post_chat"
    ),
    path(
        "get_mentor_help_chat_header/",
        views.get_mentor_help_chat_header,
        name="get_mentor_help_chat_header",
    ),
    path(
        "mentor_help_interest_message/",
        views.mentor_help_interest_message,
    ...
    path(
        ...
        views.mentor_help_users_message,
