...
class User(AbstractBaseUser , PermissionsMixin):
    ...
    profile_photo=models.ImageField(upload_to='profile_picture',null=True,blank=True,default='image/character.png')
...
class Featured_Mentor(models.Model):
    post = models.ForeignKey(Tech_Help_Post,on_delete=models.CASCADE,related_name='mentor_post',null=True)
