...
urlpatterns = [
    ...
    path('create_help_desk_post/',views.create_help_desk_post, name='create_help_desk_post'),
    path('update_help_desk_post/<int:pk>/',views.update_help_desk_post, name='update_help_desk_post'),
    path('delete_help_desk_post/',views.delete_post, name='delete_help_desk_post'),
    path('help_desk_detail_page/<int:pk>/',views.post_detail_page, name='help_desk_detail_page'),
